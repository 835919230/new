...
function createPhone(){
	...
	$('.edit-content').append('<div class="item" id="single-write">'+
						//'<input type="hidden" name="hidden" value="手机"><!-- 隐藏域记录该题目的性质 -->'+
						...
						'<input type="hidden" id="itemId" value="">'+
							...
							'<div class="item-content">'+
								'<div class="drag">'+
									'<div class="item-title"><input type="text" value="手机号码" class="h2" name="itemTitle"></div>'+
								'</div>'+
...
$('.choice-bar').find('#pho_tp').click(function(event) {
